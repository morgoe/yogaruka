...
permalink: /retreats/reclaim-yourself-marrakech-sep-2016/
...
<section>
	...
	<div class="row">
		<div class="col-sm-5 col-md-6 col-lg-7">
			<figure>
				<img src="/assets/images/retreat/overview.jpg">
			</figure>
		</div>
		<div class="col-sm-7 col-md-6 col-lg-5">
			<blockquote class="right">
				<p>Let us take you to a magical place in the heart of the Ourika Valley - an <em>exclusive eco-retreat</em> an hour out of Marrakesh into the mountains of Atlas - the rebel Titan that, petrified by the Medusa, legend says, holds the heavens on his shoulders.</p>

				<p>Join us this end of September for a week that will change you forever: take your yoga practice to the next level, with a <em>new approach on postural dynamics</em>, explore through walking meditations the marvels of the National Park of Toubkal (did you know <em>Martin Scorsese’s Kundun</em> was filmed in one of the nearby historical kasbahs?), discover the best local organic dishes, experience a real Berber Hammam, massages, and so much more.</p>
			</blockquote>
		</div>
	</div>
</section>
	...
	<div class="m-accordion">
		<ul class="m-accordion-content">
			<li id="jumpTo-setting" class="active">
				...
				<p>The estate is 4 kilometres from the town El Gastor, known as the balcony of the The White Villages of Cádiz, due to its altitude. The property is on <em>250,000 square meters of land</em> protected by automated security gates.</p>

				<figure class="m-accordion-image right">
					<img src="/assets/images/retreat/setting.jpg">
				</figure>

				<p>There are 5 clusters of country homes that are separated from each other by large distances to ensure privacy. Each of them has <em>its own private pool</em> with incredible views of the mountains.</p>
			...
			<li id="jumpTo-location">
				...
				<figure class="m-accordion-image ">
					<img src="/assets/images/retreat/location.jpg">
				</figure>
			...
			<li id="jumpTo-rooms">
				...
				<figure class="m-accordion-image right">
					<img src="/assets/images/retreat/rooms.jpg">
				</figure>

				<p class="margin-top-0">In Grazalema house there are either single or double occupancy rooms offered. All homes are beautifully decorated and all have private bathrooms attached. There is WiFi, LED TV, AC and heaters in each room. By default, you will share a room with one other student. <em>If you wish to opt for a single room</em>, there will be an additional fee of £130.</p>
			</li>
			<li id="jumpTo-meals">
				...
				<figure class="m-accordion-image ">
					<img src="/assets/images/retreat/meals.jpg">
				</figure>
				...
				<p><em>If you have any food allergies or special requests</em>, please let us know so we can prepare the best alternative for your needs.</p>
			</li>
			<li id="jumpTo-activities">
				<h3 class="m-accordion-contentTitle">Activities</h3>

				<p>The retreat will begin with a <em>full anatomical assessment</em>, so as to target the sequences to individual quirks - spine and postural issues (spondylitis, scoliosis, hyperlordosis, etc), joint issues (arthritis, chronic knee pain) - and provide <em>solutions around your lifestyle</em> (eg. how to keep a healthy posture if you sit in an office chair 8h+ a day).</p>

				<figure class="m-accordion-image right">
					<img src="/assets/images/retreat/course.jpg">
				</figure>
...
<section id="jumpTo-philosophy">
	...
	<img class="m-doubleExposure" src="/assets/images/retreat/double-exposure.jpg">
	...
	<ul class="u-pull-right list-bullets">
		...
		<li>Yoga Ruka commits to donate a <em>minimum of 10% of the profit</em> from their retreats to support environment, education and environmental education.</li>
	</ul>
</section>
...
<section id="jumpTo-prices">
	...
	<div class="row">
		<div class="col-sm-push-2 col-sm-8 col-md-push-3 col-md-6">
			...
			<ul class="m-prices-includedList margin-top-xs">
				...
				<li>
					<img src="/assets/icons/check.svg">
					3 vegetarian meals / day, all <em>locally-sourced & organic</em>
				</li>
				<li>
					<img src="/assets/icons/check.svg">
				...
				<li>
					<img src="/assets/icons/check.svg">
					a <em>full anatomical assessment</em> to customise your practice to your uniqueness
				</li>
				<li>
					<img src="/assets/icons/check.svg">
				...
				<li>
					<img src="/assets/icons/check.svg">
					a <em>traditional Hammam</em> bath, scrub & body mask treatment
				</li>
				<li>
					<img src="/assets/icons/check.svg">
				...
				<li>
					<img src="/assets/icons/check.svg">
					<em>2 Ayurvedic massages</em>: full body & foot/reflexology 
				</li>
				<li>
					<img src="/assets/icons/check.svg">
	...
	<p class="center">This is why Ruka Yoga commit to <em>donate a minimum 10% of their profits</em> to support projects such as the protection of this incredible natural reserve through O-Live Environmental Association, but also the education of disadvantaged children in India through organisations such as Make a difference or Nanhi Kali.</p>

	{% include retreat-form-2016-may-spain.html %}

	<p class="center">By purchasing this deposit, you accept and agree to our <a href="/terms/">terms and conditions</a>. Don't worry, they're not scary!</p>
